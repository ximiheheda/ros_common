...
static void mavlink_test_targetdirection(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TARGETDIRECTION >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_targetdirection_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,963498712
    };
    mavlink_targetdirection_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.front_center = packet_in.front_center;
        packet1.front_left = packet_in.front_left;
        packet1.front_right = packet_in.front_right;
        packet1.rear_left = packet_in.rear_left;
        packet1.rear_right = packet_in.rear_right;
        packet1.back = packet_in.back;
        packet1.ground = packet_in.ground;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TARGETDIRECTION_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TARGETDIRECTION_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_targetdirection_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_targetdirection_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_targetdirection_pack(system_id, component_id, &msg , packet1.front_center , packet1.front_left , packet1.front_right , packet1.rear_left , packet1.rear_right , packet1.back , packet1.ground );
    mavlink_msg_targetdirection_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_targetdirection_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.front_center , packet1.front_left , packet1.front_right , packet1.rear_left , packet1.rear_right , packet1.back , packet1.ground );
    mavlink_msg_targetdirection_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_targetdirection_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_targetdirection_send(MAVLINK_COMM_1 , packet1.front_center , packet1.front_left , packet1.front_right , packet1.rear_left , packet1.rear_right , packet1.back , packet1.ground );
    mavlink_msg_targetdirection_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_targetdirection(system_id, component_id, last_msg);
}
